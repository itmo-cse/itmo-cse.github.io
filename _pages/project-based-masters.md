...
В проектной магистратуре может учиться любой студент, прошедший вступительные
испытания (конкурсы или экзамены) и зачисленный в университет. Но ментор
проводит собеседование с каждым, кто хочет попасть к нему в проект. Поэтому в
описании каждого проекта указаны требования к потенциальным участникам.

# Как попасть в проектную магистратуру?

- Выберите один из проектов и подайте заявку. Ментор получит письмо и свяжется
  с Вами для собеседования. После успешного собеседования Вы в магистратуре :) 
- Также подайте документы в приёмную комиссию на сайте
  [abit.itmo.ru](https://abit.itmo.ru) и пройдите вступительные испытания, если
Вы этого еще не сделали. 

А если что-то непонятно, то пишите [Дмитрию Ильичу
Муромцеву]({{site.url}}/staff_members/mouromtsev), куратору проектной
магистратуры нашего факультета.

# 6 преимуществ обучения в проектной магистратуре

1. Возможность комфортно совмещать учёбу и работу в интересных проектах.
  Работодатель и университет уже согласовали такой режим для Вас.
2. У Вас гарантированно есть время на учёбу и развитие, это поможет карьерному росту.
...
Напишите [Дмитрию Ильичу Муромцеву]({{site.url}}/staff_members/mouromtsev), координатору проектной магистратуры. 
